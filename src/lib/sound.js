...
const PlayBackRates = [.25, .35, .45, .55, .65, .75, .85, 1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5]
let SND;
...
export const adjustSound = (distance) => {
...
export const mkSound = (distance, thing) => {
  startSound(thing);
  adjustSound(distance);
}
